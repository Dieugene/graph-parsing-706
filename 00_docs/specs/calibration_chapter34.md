  ...
  "sections": [
    {
      ...
      "parent_section": "наименование родительского раздела или null",
      "fields": [
        {
          ...
          "subfields": [ ...та же структура... ] или null
        }
      ]
    }
  ],
  "deprecated_elements": [
    {
      ...
      "location": "в каком разделе находился"
    }
  ]
}
...
1. Сохраняй иерархию: раздел → подраздел → поле → подполе.
