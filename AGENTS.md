...
**Название:** Регистрация ценных бумаг - регуляторный граф

**Описание:** Парсинг положения "О стандартах эмиссии ценных бумаг" Банка России, и связанных документов. Формирование графа зависимостей "регистрационные действия - требуемые документы - требуемые поля".

**Цель:** Решаем проблему сложности восприятия массива регуляторных требований, подготовки фундамента для последующего упрощения и оптимизации регулирования.
